...
\begin{longtable}{m{\textwidth-2.2cm} m{1.5cm}}
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_change_user}} \\[0.6cm] \hline \\[-1em]

	\textbf{Back}: Used to indicate that the user can go back & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_back}} \\[0.6cm] \hline \\[-1em]

	\textbf{Log out}: Used to indicate that the user can log out of the application & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_logout}} \\[0.6cm] \hline \\[-1em]
\end{longtable}
...
\begin{longtable}{m{\textwidth-2.2cm} m{1.5cm}}
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_camera}} \\[0.6cm] \hline \\[-1em] 
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_camera_switch}} \\[0.6cm] \hline \\[-1em] 
\end{longtable}
...
\begin{longtable}{m{\textwidth-2.2cm} m{1.5cm}}
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_microphone}} \\[0.6cm] \hline \\[-1em]

	\textbf{Microphone (off)}: Used to indicate that the microphone is unavailable & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_microphone_off}} \\[0.6cm] \hline \\[-1em]

	\textbf{Microphone (on)}: Used to indicate that the microphone is currently in use & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_microphone_on}} \\[0.6cm] \hline \\[-1em] 
\end{longtable}
...
\begin{longtable}{m{\textwidth-2.2cm} m{1.5cm}}
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_record}} \\[0.6cm] \hline \\[-1em]

	\textbf{Stop}: Used to indicate that either something playing or recording can be stopped & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_stop}} \\[0.6cm] \hline \\[-1em]
\end{longtable}
...
\begin{longtable}{m{\textwidth-2.2cm} m{1.5cm}}
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_arrow_down}} \\[0.6cm] \hline \\[-1em]

	\textbf{Arrow (left)}: X & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_arrow_left}} \\[0.6cm] \hline \\[-1em]

	\textbf{Arrow (right)}: X & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_arrow_right}} \\[0.6cm] \hline \\[-1em]

	\textbf{Arrow (up)}: X & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_arrow_up}} \\[0.6cm] \hline \\[-1em]
\end{longtable}
...
\begin{longtable}{m{\textwidth-2.2cm} m{1.5cm}}
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_regret}} \\[0.6cm] \hline \\[-1em]

	\textbf{Redo}: Used to indicate that an undone action can be redone & \parbox[c]{1.2cm}{
	\reflectbox{\includegraphics[width=1.5cm]{icon_examples/icon_regret}}} \\[0.6cm] \hline \\[-1em]

	\textbf{Synchronize}: Used to indicate that data can be synchronize to/from the server & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_synchronize}} \\[0.6cm] \hline \\[-1em]

	\textbf{Save}: Used to indicate that actions performed can be saved & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_save}} \\[0.6cm] \hline \\[-1em] 

	\textbf{Cancel}: Used to indicate that some action can be canceled & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_cancel}} \\[0.6cm] \hline \\[-1em]
\end{longtable}
...
\begin{longtable}{m{\textwidth-2.2cm} m{1.5cm}}
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_add}} \\[0.6cm] \hline \\[-1em]

	\textbf{Rotate}: Used to indicate that something can be rotated & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_rotate}} \\[0.6cm] \hline \\[-1em]

	\textbf{Resize}: Used to indicate that something can be resized & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_resize}} \\[0.6cm] \hline \\[-1em]

	\textbf{Copy}: Used to indicate that something can be copied & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_copy}} \\[0.6cm] \hline \\[-1em]

	\textbf{Edit}: Used to indicate that something can be edited & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_edit}} \\[0.6cm] \hline \\[-1em]

	\textbf{Delete}: Used to indicate that something can be deleted & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_delete}} \\[0.6cm] \hline \\[-1em]

	\textbf{Change Pictogram}: Used to indicate that a pictogram can be changed or set & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_change_picto}} \\[0.6cm] \hline \\[-1em]

	\textbf{Search}: Used to indicate that a search-action can be performed & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_search}} \\[0.6cm] \hline \\[-1em]
\end{longtable}
...
\begin{longtable}{m{\textwidth-2.2cm} m{1.5cm}}
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_help}} \\[0.6cm] \hline \\[-1em]

	\textbf{Settings}: Used to indicate that the user might adjust settings & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_settings}} \\[0.6cm] \hline \\[-1em]
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_change_land_to_port}} \\[0.6cm] \hline \\[-1em] 
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_change_port_to_land}} \\[0.6cm] \hline \\[-1em]
\end{longtable}
...
\begin{longtable}{m{\textwidth-2.2cm} m{1.5cm}}
	...
	\includegraphics[width=1.5cm]{icon_examples/icon_accept}} \\[0.6cm] \hline \\[-1em]

	\textbf{Choose}: Used to indicate that the user should make a choice & \parbox[c]{1.2cm}{
	\includegraphics[width=1.5cm]{icon_examples/icon_choose}} \\[0.6cm] \hline \\[-1em]
\end{longtable}