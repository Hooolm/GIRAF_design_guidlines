...
\todo[inline]{Add reference to the colors used and describe the gradient}
...
\todo[inline]{Update this image based on the new guides described below}
...
\todo[inline]{Mention that sidebar has an exception regarding margin. Markings of items in sidebar should not have margin to the edge of the sidebar}
\todo[inline]{Add reference to the colors used and describe the gradient}
...
\todo[inline]{Tell that a screen can never be empty, if you have an empty screen in an activity, add some text to guide the user}.
...
\end{note}\todo[inline]{The effect of this could be explained more clearly using a figure}

\todo[inline]{Describe consistency between creation editing and showing of elements. Eg. the creation editing and showing of categories should be consistent. This regards the layout of the forms}
