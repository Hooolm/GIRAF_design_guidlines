...
\todo{Add reference to the colors use and describe the gradient}
...
Side bars need not, but may be contextual. Side bars may be used to switch between content of applications - for instance if the application is split into two parts (side bar and content). A side bar should look like \figref{fig:side_bar_example}. Side bars may not use more than $20\%$ of the total screen estate.
