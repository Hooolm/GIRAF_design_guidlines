...
\label{sub:adding_items}

\todo[inline]{Describe what icons should be used to add items to a list. Sekvens, Ugeplan og Brugerhåndtering uses three types of indicators.}
