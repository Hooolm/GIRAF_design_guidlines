...
\todo[inline]{Create a label for each color. Create some way of referencing to the colors colref and colpageref}
...
\index{Image}
\index{Colors!Image}
\todo[inline]{Describe colors of images. Border color (black), background color (white), marking color (orange)}
