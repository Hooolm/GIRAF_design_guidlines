...
In cases where the system needs to perform some action that takes a long time to execute (See \secref{sub:long_tasks}), to indicate that the system is not frozen, the waiting dialog, as it looks in \figref{fig:dialog_waiting}, can be used. \todo{refer to appendix}.
...
\todo[inline]{Describe GirafCustomButtonsDialog}