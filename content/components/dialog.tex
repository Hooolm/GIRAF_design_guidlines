...
When the user has to respond to a specific event, dialogs should be used. A dialog consists of a title, a description, some buttons and possibly some additional views. In \gc there exists some classes for this purpose. The general layout of a dialog can be seen in \figref{fig:inflatable_dialog}. For a guide of how these dialogs can be implemented see \appref{cha:implementation_guide_for_dialogs}.
...
\begin{note}
	The buttons of the dialog should comply with the rules described in \secref{sec:button_context}.
\end{note}
